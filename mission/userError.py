...
Error53901 = UserError(53901, "气泵推出超时,请检测气压与对应的检测开关")
Error53902 = UserError(53902, "气泵推回超时,请检测气压与对应的气缸")
...
Error53909 = UserError(53909, "AGV 与 Robot Modbus 心跳超时,请检测网络设置和网络链接")
